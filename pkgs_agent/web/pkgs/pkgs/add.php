...
require_once(abspath("pkgs/includes/functions.php"));
require_once(abspath("pkgs/includes/query.php"));
require_once(abspath("pkgs/includes/class.php"));
...
//     );
    ...
    if(isExpertMode())
    {
        ...
        $packagesInOption = '';
        foreach(xmpp_packages_list($path) as $package)
        {
...
<script src="<?php absurl("pkg/lib/fileuploader/fileuploader.js");?>"
    type="text/javascript"></script>
<!-- js for file upload -->
<link href="<?php absurl("pkg/lib/fileuploader/fileuploader.css");?>"
    ...
    jQuery(function() { // load this piece of code when page is loaded
        ...
        function refreshTempPapi() {
            ...
            if (packageMethodValue == "package") {
                ...
                jQuery('#package-temp-directory').load('<?php echo urlStrRedirect(absurl("pkgs/pkgs/ajaxRefreshPackageTempDir")) ?>&papi=' + selectedPapi, function() {
